<template>
    <section class="cookieControl" v-if="cookies.text">
        ...
        <button class="cookieControl__ControlButton"
        ...
        <transition name="cookieControl__Modal">
            <div class="cookieControl__Modal" v-if="cookies.modal">
                ...
                <div class="cookieControl__ModalContent">
                    <div>
                        <slot name="modal"/>
                        <button @click="cookies.modal = false"
                            ...
                            <ul :key="type.id">
                                <li v-for="cookie in cookies[type]" :key="cookie.id">
                                    <div class="cookieControl__ModalInputWrapper">
                                        <input v-if="type === 'necessary' && cookie.name !== 'functional'"
                                        ...
                                        <input v-else
                                               :id="getCookieFirstName(cookie.name)"
                                               type="checkbox"
                                               :checked="cookies.enabledList.includes(cookie.identifier || cookies.slugify(getCookieFirstName(cookie.name))) || (cookies.get('cookie_control_consent').length === 0 && cookie.initialState === true)"
                        ...
                        <div class="cookieControl__ModalButtons">
                            ...
                            <button @click="setConsent"
                                    v-if="cookies.enabledList.length < optionalCookies.length"
